  ...
  menu: {
    ...
    Appetizers: {
      ...
      4: {
        ...
        description:
          "The finest of onion rings served with 9 different dipping sauces.",
        price: 14.5
      }
    },
    Combos: {
      5: {
        ...
        description:
          "An arm and a leg, a side of cheek meat, and a buttered biscuit.",
        price: 15.99
      },
      6: {
  ...
  menu: {
    ...
    Combos: {
      ...
      4: {
        ...
        description:
          "All you need for a long journey - 6 pieces of lembas, salted pork, and a flagon of wine.",
        price: 25.99
      },
      5: {
...
let frodo = {
  ...
  menu: {
    ...
    //     description:
    //       "Eight flapjacks, two sausages, 3 eggs, 4 slices of bacon, beans, and a coffee.",
    //     price: 14.0
    //   },
    //   2: {
    ...
    "Second Breakfast": {
      ...
      5: {
        ...
        description:
          "6 flapjacks covered in fresh blackberries. Served with a large side of sausage.",
        price: 14.99
      }
    },
    Elevenses: {
      ...
      7: {
        ...
        description:
          "A variety of 8 different types of muffins, served with tea.",
        price: 9.0
      },
      8: {
    ...
    Supper: {
      21: {
        ...
        description:
          "Six whole sausages served on a loaf of bread. Covered in onions, mushrooms and gravy.",
        price: 15.99
      },
      22: {
        name: "Shire Supper",
        description:
          "End the day as you started it, with a dozen flapjacks, 5 eggs, 3 sausages, 7 pieces of bacon, and a pint of ale.",
        price: 37.99
      }
    }
  }
...
for (const [c, items] of Object.entries(frodo.menu)) {
  category.innerHTML += `<p><a href=#>${c}</a></p>`;
